...
public class SporterDaoJpa implements SporterDao {
	...
	public List<Sporter> findAll() {
		 ...
		 sporters.get(0).voegReductieBonToe(new Reductiebon("R31", 10, LocalDate.of(2023, 11, 30)));
		 sporters.get(0).voegReductieBonToe(new Reductiebon("R311", 60, LocalDate.of(2024, 5, 10)));
		 ...
		 sporters.get(3).voegReductieBonToe(new Reductiebon("R34", 10, LocalDate.of(2025, 1, 1)));
		 
		 sporters.get(5).voegReductieBonToe(new Reductiebon("R36", 10, LocalDate.of(2024, 4, 1)));
